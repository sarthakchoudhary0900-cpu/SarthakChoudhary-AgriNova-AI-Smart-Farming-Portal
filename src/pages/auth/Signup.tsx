...
import { Mail, Lock, Eye, EyeOff, Sprout, User, ArrowRight, Phone } from 'lucide-react';
      ...
      >
        <div className="glass p-8 md:p-10">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold font-display text-forest-800 dark:text-brand-50">Join AgriNova</h1>
            <p className="text-forest-500 dark:text-brand-200/60 mt-1.5">Create your smart farming account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-forest-700 dark:text-brand-100 mb-1.5">Phone (optional)</label>
              <div className="relative">
